...
export const removeEmployee = createAsyncThunk("employee/removeEmployee",
    async (data) => {
        const response = await axios.delete(`/items/${data}`);
        return response.data.response;
    }
);

export const modifiedEmployee = createAsyncThunk("employee/modifiedEmployee",
    async (data) => {
        const response = await axios.put(`/items/${data.id}`, {
            name: data.name,
            position: data.position,
        });
        return response.data.response;
